...
namespace FinanceiroSolution.Domain.Entidades
{
    ...
    public Despesa(Categoria categoria, string nome, decimal valor, int mes, int ano, EnumTipoDespesa tipoDespesa, DateTime dataCadastro,
        ...
        public Despesa(int categoriaId, string nome, decimal valor, int mes, int ano, EnumTipoDespesa tipoDespesa, DateTime dataCadastro,
                     DateTime DataPagamento, DateTime DataVencimento, bool pago, bool despesaAtrasada)
        {
