...
namespace Financeiro.Solution.View.Controllers
{
    ...
    public class CategoriaController : ControllerBase
    {
        ...
        public async Task<object> ListarCategoriasUsuario(string emailUsuario)
        {
            try
            {
                _logger.LogInformation("Executandoss atualizando para AZURE o método Listar erros para aparecer azure Categoria por Conta de Email:{emailUsuario}",emailUsuario);
            ...
            {
                _logger.LogError(ex, "Ocorreu um erro ao executar o método ListarCategoriasUsuario TESTESDADA");
